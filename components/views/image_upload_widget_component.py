"""Компонент виджета загрузки изображений (Page Factory)."""
...
class ImageUploadWidgetComponent(BaseComponent):
    """Управляет информационным блоком, превью и действиями загрузки."""
    ...
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_icon = Icon(page, f'{identifier}-image-upload-widget-info-icon', 'Иконка информации')
        self.image_upload_info_title = Text(page, f'{identifier}-image-upload-widget-info-title-text', 'Подсказка')
        ...
        self.upload_button = Button(page, f'{identifier}-image-upload-widget-upload-button', 'Загрузить изображение')
        self.remove_button = Button(page, f'{identifier}-image-upload-widget-remove-button', 'Удалить изображение')
        self.upload_input = FileInput(page, f'{identifier}-image-upload-widget-input', 'Выбор файла')

    def check_visible(self, is_image_uploaded: bool = False):
        """Проверяет состояние виджета в зависимости от загруженного изображения."""
    ...
    def upload_preview_image(self, file: str):
        """Загружает файл в инпут виджета."""
