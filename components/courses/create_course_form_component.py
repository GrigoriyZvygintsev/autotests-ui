...
class CreateCourseFormComponent(BaseComponent):
    """Инкапсулирует работу с полями формы курса."""
    ...
    def fill(
        ...
        """Заполняет форму указанными значениями и проверяет инпуты."""
    ...
    def check_visible(
        ...
        """Проверяет, что форма отображается с ожидаемыми значениями."""
